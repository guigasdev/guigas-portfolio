  ...
  return (
    <section id="contact" className={styles.container}>
      <div className="mx-auto w-full max-w-6xl px-6">
        ...
        <p className="mx-auto mb-4 max-w-2xl text-slate-300">{t('contact.blurb')}</p>
        <div className="mb-6 flex justify-center">
          <a
            href="https://wa.me/5585992433782"
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-2 rounded-md border border-emerald-500/30 bg-emerald-500/10 px-4 py-2 text-emerald-300 transition hover:border-emerald-500 hover:bg-emerald-500/20"
          >
            <MessageCircle size={18} /> {t('contact.cta')}
          </a>
        </div>
        <form action="https://formspree.io/f/xnnaadqr" method='post' className="mx-auto w-full max-w-2xl">
